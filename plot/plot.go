...
var (
	...
	htmlTemplate = template.Must(template.New("github.com/kevinroundy/dataframe-go/plot/html").Parse(titleHTML))
	imgTemplate  = template.Must(template.New("github.com/kevinroundy/dataframe-go/plot/img").Parse(imgHTML))
)
